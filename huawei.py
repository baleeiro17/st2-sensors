    ...
    try:
        ...
        if vendor == "huawei":
            ...
            if tipo_olt:
                ...
                gera_proc_service_port_huawei_segunda(clientes, hostname_origem, depara, vlan_voip_antiga, vlan_voip_nova)
    ...
    try:
        ...
        if vendor == "huawei":
            ...
            if tipo_olt:
                ...
                aplicacao = gera_proc_service_port_huawei_aplicacao_segunda(clientes, vlan_voip_antiga, vlan_voip_nova, depara)
